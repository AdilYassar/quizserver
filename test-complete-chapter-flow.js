...
import dotenv from        // Step 2: Get theory chapters
        ...
        console.log(`\n📈 Step 3: Testing chapter status progression...`);env.config();
...
async function testCompleteChapterFlow() {
    try {
        ...
        console.log(`\n📚 Step 1: Getting theory chapters for AI course...`);
        const theoryResponse = await axios.get(`${BASE_URL}/theory/${AI_COURSE_ID}`, { headers });
        ...
        // Step 2: Test chapter status progression
        console.log(`\n📈 Step 2: Testing chapter status progression...`);
        
        // 2a. Mark chapter as started
        ...
        // 2b. Mark chapter as in progress
